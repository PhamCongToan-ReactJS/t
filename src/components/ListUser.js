  ...
  get editingRow() {
    ...
    return (
      <tr>
        ...
        <td>
          <input type='text' value={user.fullName} onChange={this.changeName} className='form-control'></input>
        </td>

        <td>
          <select className='form-control' defaultValue={user.gender} onChange={this.changeGender}>
        ...
        <td>
          <input type='number' value={user.age} onChange={this.changeAge} className='form-control'></input>
        </td>
        ...
        <td>
          ...
          <button className="btn btn-danger" onClick={() => this.props.deleteItem(user.id, false)}>Delete</button>
        </td>
      </tr>
    )
  }
